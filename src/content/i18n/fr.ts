...
export const fr: Dictionary = {
    ...
    services: {
      ...
      cards: [
        ...
        },
        {
          ...
          items: [
            { t: "Connexions API & webhooks" },
            { t: "Synchronisation des données" },
            { t: "Migration propre entre outils" },
            { t: "CRM, courriel, boutique, tableurs" },
          ],
          cta: "En savoir plus",
        },
        {
        ...
        },
        {
          ...
          outcome: "Résultat : un plan priorisé et chiffré, à vous de jouer.",
          items: [
            { t: "Analyse de vos processus" },
            { t: "Goulots & gains rapides" },
  ...
  services: {
    automatisation: {
      ...
      metaDescription:
        "On automatise vos tâches répétitives avec des règles fiables. Suivis, relances et tri qui se font seuls. Devis sous 48 h, sans engagement.",
    ...
    integration: {
      ...
      whatBody: [
        "On connecte les outils que vous utilisez déjà. Votre CRM, vos courriels, votre boutique Shopify, votre comptabilité, vos tableurs et vos calendriers finissent par se parler.",
      ...
      useCases: [
        { title: "Boutique et comptabilité", desc: "Chaque vente Shopify crée la facture et met vos chiffres à jour, sans ressaisie." },
    ...
    sitesBoutiques: {
      ...
      faq: [
        ...
        { q: "Avec quelles plateformes de boutique en ligne travaillez-vous ?", a: "On travaille avec Shopify et les principales plateformes de commerce en ligne. On part de vos besoins et de votre stack actuelle plutôt que de vous imposer un outil." },
        { q: "Qui s'occupe de l'hébergement et de l'entretien ?", a: "Vous restez propriétaire de l'hébergement, à votre nom. On peut prendre en charge l'entretien et les mises à jour, ou vous laisser autonome, selon ce qui vous convient." },
        { q: "De quoi avez-vous besoin de ma part pour commencer ?", a: "Vos textes, vos images et votre logo si vous en avez, plus une idée de vos objectifs. On vous guide pour le reste, rien de technique n'est exigé de votre part." },
      ],
      ctaLabel: "Sur mesure",
