...
export function ValueCalculator() {
  ...
  return (
    <section
      id="calculator"
      className="scroll-mt-24 border-b border-[var(--border)] bg-[var(--background)] py-20 sm:py-28"
    ...
    >
      <Container>
        ...
        <div className="mt-12 grid gap-10 lg:grid-cols-2 lg:gap-16">
            ...
            <label className="block">
              ...
              <div className="mt-3 flex items-center gap-4">
                <input
                  ...
                  className="h-2 w-full max-w-md cursor-pointer accent-[var(--accent)]"
                />
          ...
          <div className="flex flex-col justify-center rounded-2xl border border-[var(--border-strong)] bg-[var(--surface)]/80 p-8 shadow-[0_0_0_1px_var(--glow-1)]">
